...
class ArabicText
{
    ...
    /**
     * تعبير SQL يطبّع عموداً بنفس توحيد normalize() (الألف/الياء/التاء المربوطة/الهمزات)
     * حتى تتم المقارنة داخل MySQL: «احمد» تطابق «أحمد» و«فاطمه» تطابق «فاطمة».
     * (التشكيل لا يُزال في SQL — الأسماء تُخزَّن بلا تشكيل أصلاً، والاستعلام يُطبَّع بـ normalize().)
     * ملاحظة: $column اسم عمود ثابت من الكود، لا مدخل مستخدم.
     */
